  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <PageContainer maxWidth="md" className="py-8 pb-20 relative z-10">
        ...
        <h1 className="font-display text-2xl sm:text-3xl font-bold text-foreground text-center">Política de Privacidade</h1>
        <div className="mx-auto mt-4 h-px w-12 bg-gradient-to-r from-transparent via-gold/10 to-transparent" />
        <p className="mt-5 text-[13px] text-muted-foreground/35 text-center leading-[1.8]">Como protegemos seus dados e seu acesso.</p>

        <div className="mt-12 space-y-8 text-[14px] leading-[2] text-foreground/55">
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">1. Dados de Login</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">2. Proteção de Acesso</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">3. Segurança da Conta</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">4. Privacidade do Usuário</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">5. Comunicação</h2>
