  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="sticky top-0 z-30 border-b border-border/15 bg-background/95 backdrop-blur-xl">
        <div className="mx-auto max-w-[1800px] flex items-center gap-3 px-4 sm:px-6 h-12">
          <Link
            to="/cursos/$courseId"
            params={{ courseId }}
            className="flex items-center gap-1.5 text-muted-foreground/50 hover:text-foreground/70 transition-colors shrink-0"
          >
            <ChevronLeft className="h-4 w-4" />
          ...
          <div className="flex items-center gap-2 min-w-0 flex-1">
            <div className="min-w-0 flex-1">
              <h2 className="text-xs font-semibold text-foreground/70 truncate">
                {course.title}
              </h2>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <span className="text-[10px] font-semibold text-gold/60 tabular-nums">
              {currentLessonIndex >= 0 ? currentLessonIndex + 1 : "–"}/{totalLessons}
            </span>
              ...
              <div className="flex items-center justify-center gap-3 px-4 sm:px-6 py-3">
                {prevLesson ? (
                  <Link
                    ...
                    className="flex items-center gap-1.5 rounded-xl border border-border/15 bg-card/5 px-4 py-2 text-[11px] font-medium text-muted-foreground/50 hover:bg-card/15 hover:text-foreground/70 transition-all"
                  >
                  ...
                  <button
                    disabled
                    className="flex items-center gap-1.5 rounded-xl border border-border/8 bg-card/3 px-4 py-2 text-[11px] font-medium text-muted-foreground/20 cursor-not-allowed"
                  >
                    <ChevronLeft className="h-3 w-3" />
                    <span className="hidden sm:inline">Anterior</span>
                    <span className="sm:hidden">Ant.</span>
                ...
                {enrollment && (
                  <Button
                    ...
                    className={`gap-1.5 px-5 text-[11px] font-bold uppercase tracking-wider ${
                      isCompleted
                        ? "bg-emerald-500/10 text-emerald-400/60 border border-emerald-500/12 hover:bg-emerald-500/15"
                ...
                {nextLesson ? (
                  <Link
                    ...
                    className="flex items-center gap-1.5 rounded-xl border border-gold/15 bg-gold/[0.06] px-4 py-2 text-[11px] font-medium text-gold/60 hover:bg-gold/12 hover:text-gold transition-all"
                  >
          ...
          <div className={`${sidebarOpen ? "block" : "hidden"} lg:block`}>
            ...
            <div className="p-4 border-b border-border/10">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-xs font-bold text-foreground/70 hidden lg:block">
                  Conteúdo do curso
                </h3>
              ...
              <p className="text-[10px] text-muted-foreground/40 mb-2.5 hidden lg:block">
                {completedCount} de {totalLessons} concluídas
              </p>
              ...
              {isCourseCompleted && (
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  className="flex items-center justify-center gap-2 rounded-lg bg-player-completed/8 border border-player-completed/12 py-2 px-3 mb-3"
                >
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-8 h-8 text-[11px] bg-card/5 border-border/12 placeholder:text-muted-foreground/25"
                />
              </div>
            </div>
