  ...
  const renderLesson = (lesson: any, index: number) => {
    ...
    const lessonTitleClasses = `text-sm font-medium truncate block transition-colors ${
      completed
        ...
        : canOpenLesson
          ? "text-foreground/90 hover:text-gold/70"
    ...
    return (
      ...
      >
        ...
        <span className="text-xs font-bold text-muted-foreground/15 tabular-nums shrink-0 w-6 text-center">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-1">
            ...
            {!canOpenLesson && (
              <span className="inline-flex items-center gap-1 text-[11px] uppercase tracking-wider text-muted-foreground/25 font-semibold">
        ...
        {!completed && enrollment && (
          <button
            ...
            className="shrink-0 text-[11px] uppercase tracking-wider text-muted-foreground/20 hover:text-emerald-400/50 transition-colors font-semibold"
          >
            Concluir
          </button>
        )}
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="text-xs text-muted-foreground/25 shrink-0">
