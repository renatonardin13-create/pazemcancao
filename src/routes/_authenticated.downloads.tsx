  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 sm:px-6 py-3.5">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gold/10 border border-gold/20 shadow-sm">
              <Music className="h-4.5 w-4.5 text-gold" />
            </div>
            <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 py-12 sm:py-16 text-center relative z-10">
          <motion.div
          ...
          >
            <motion.div
              ...
              className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-gold/10 border border-gold/20 shadow-lg shadow-gold/5"
            >
      ...
      <section className="mx-auto max-w-5xl px-4 sm:px-6 pt-8 sm:pt-10">
        <motion.div
          ...
          className="rounded-2xl border border-gold/15 bg-gold/[0.03] backdrop-blur-sm px-5 sm:px-6 py-5 flex items-start gap-4 shadow-sm"
        >
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gold/10 mt-0.5">
            <Heart className="h-4 w-4 text-gold" />
          </div>
          <p className="text-sm leading-relaxed text-foreground/70">
            Essas canções foram preparadas para ser{" "}
            <span className="font-medium text-foreground">paz</span> nos seus dias difíceis,{" "}
            <span className="font-medium text-foreground">força</span> na sua caminhada e{" "}
      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 py-8 sm:py-10">
        ...
        <div className="flex items-center gap-2 mb-5">
          <ListMusic className="h-4.5 w-4.5 text-gold" />
