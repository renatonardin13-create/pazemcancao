    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center gap-6 animate-in fade-in duration-1000">
          ...
          <p className="text-[11px] font-medium uppercase tracking-[0.4em] text-gold/70">
          ...
          <div className="relative max-w-sm text-center px-8 animate-in fade-in slide-in-from-bottom-6 duration-1000">
            ...
            <div className="mt-10 flex flex-col items-center gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.3em] text-muted-foreground/70 hover:text-muted-foreground/55 transition-colors duration-500"
              >
      ...
      <div className="flex min-h-screen items-center justify-center bg-background relative overflow-hidden">
        ...
        <div className="relative max-w-sm text-center px-8 animate-in fade-in slide-in-from-bottom-6 duration-1000">
          ...
          <div className="mt-6 flex flex-col items-center gap-3">
            ...
            <button
              onClick={handleLogout}
              className="flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.3em] text-muted-foreground/60 hover:text-muted-foreground/45 transition-colors duration-500 mt-2"
            >
              <LogOut className="h-3 w-3" />
              Sair
            </button>
