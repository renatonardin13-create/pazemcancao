  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <PageContainer maxWidth="md" className="py-8 pb-20 relative z-10">
        ...
        <h1 className="font-display text-2xl sm:text-3xl font-bold text-foreground text-center">Termos de Uso</h1>
        ...
        <div className="mt-12 space-y-8 text-[14px] leading-[2] text-foreground/55">
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">1. Aceitação dos Termos</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">2. Uso Individual</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">3. Proteção de Conteúdo</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">4. Proibição de Compartilhamento</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">5. Direitos Autorais</h2>
          ...
          <section>
            <h2 className="text-[13px] font-semibold text-foreground/90 mb-3 uppercase tracking-wider">6. Contato</h2>
