...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b bg-muted/8", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border/20 transition-colors hover:bg-muted/15 data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
