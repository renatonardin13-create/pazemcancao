  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="group relative flex items-center gap-2 rounded-xl px-3 py-2 text-muted-foreground/70 hover:text-gold/60 hover:bg-muted/15 transition-all duration-500"
      >
                ...
                >
                  ...
                  {!n.is_read && (
                    <button
                      ...
                      className="mt-1 p-1 text-muted-foreground/50 hover:text-gold/60 transition-colors"
